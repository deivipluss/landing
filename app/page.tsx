 ...
 <div>
   ...
   <div className="flex flex-row gap-8 md:gap-4 text-center text-[#E1E1E1] justify-center mt-8 px-4 md:px-0">
     <div className="flex flex-col items-center">
       <p className="text-[40px] md:text-[60px] font-poppins font-black text-[#4A90E2] leading-none" style={{ letterSpacing: "-1px" }}>+10</p>
       <p className="text-[11px] md:text-[13px] text-gray-400 max-w-[80px] leading-tight mt-2 font-poppins font-medium">
         AÑOS DE<br />EXPERIENCIA
       </p>
     </div>
     <div className="flex flex-col items-center">
       <p className="text-[40px] md:text-[60px] font-poppins font-black text-[#4A90E2] leading-none" style={{ letterSpacing: "-1px" }}>+100</p>
       <p className="text-[11px] md:text-[13px] text-gray-400 max-w-[80px] leading-tight mt-2 font-poppins font-medium">
         CLIENTES<br />ASESORADOS
       </p>
     </div>
     <div className="flex flex-col items-center">
       <p className="text-[40px] md:text-[60px] font-poppins font-black text-[#4A90E2] leading-none" style={{ letterSpacing: "-1px" }}>+50</p>
       <p className="text-[11px] md:text-[13px] text-gray-400 max-w-[80px] leading-tight mt-2 font-poppins font-medium">
   ...
   <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
     <div className="bg-[#FF5C5C] text-white p-6 rounded-lg relative shadow-md h-[180px] flex flex-col">
       <RiCustomerService2Line className="text-3xl mb-4" />
       <h3 className="text-xl font-poppins font-semibold mb-2">CONOCE MIS SERVICIOS</h3>
       <div className="absolute bottom-4 right-4 bg-white/20 p-2 rounded-lg">
         <span className="text-xl">→</span>
       </div>
     </div>
     <div className="bg-[#32CD32] text-white p-6 rounded-lg relative shadow-md h-[180px] flex flex-col">
       <RiMessage2Line className="text-3xl mb-4" />
       <h3 className="text-xl font-poppins font-semibold mb-2">CONTACTA CONMIGO</h3>
       <div className="absolute bottom-4 right-4 bg-white/20 p-2 rounded-lg">
         <span className="text-xl">→</span>
       </div>
     </div>
