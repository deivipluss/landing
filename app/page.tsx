...
const HomePage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 text-gray-800 overflow-hidden">
      ...
      {/* Footer */}
      <footer className="w-full bg-gray-200 text-gray-600 py-6 text-center absolute bottom-0">
