  ...
  return (
    <div className="bg-gray-100">
      ...
      <header className="flex justify-between items-center p-5 bg-blue-600 text-white">
        <h1 className="text-2xl font-bold">Deivis Contreras Cárdenas</h1>
        <nav>
      ...
      <section className="flex flex-col items-center justify-center min-h-screen bg-blue-500 text-white text-center">
        <h2 className="text-4xl font-bold">Transformación Digital y Marketing</h2>
        <p className="mt-4 text-lg">Impulsa tu negocio al siguiente nivel con estrategias efectivas.</p>
