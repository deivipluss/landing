...
import { Brain, Code, BarChart2, Globe, Briefcase, ArrowUpIcon as FaArrowUp } from 'lucide-react';
...
const navItems = [
  { 
    href: "/", 
    icon: <Brain className="transition-transform duration-300 group-hover:rotate-180" />, 
    label: "Home" 
  },
  { 
    href: "#solutions", 
    icon: <Code className="transition-transform duration-300 group-hover:scale-110" />, 
    label: "Soluciones" 
  },
  { 
    href: "/novedades-tech", 
    icon: <BarChart2 className="transition-transform duration-300 group-hover:scale-110" />, 
    label: "Tech News" 
  },
  { 
    href: "/contacto", 
    icon: <Globe className="transition-transform duration-300 group-hover:rotate-12" />, 
    label: "Contacto" 
  },
];
...
const GerenciaDigital: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0D0C1D] to-[#1A1A2E] text-white">
      ...
      <main ref={mainRef} className="container mx-auto px-4 pt-16 sm:pt-20 md:pt-24 lg:pt-32 flex flex-col items-center">
        <motion.div 
        ...
        >
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
              <span className="text-[#4A90E2] drop-shadow-glow">IMPULSO</span>
